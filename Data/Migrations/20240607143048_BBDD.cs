    ...
    public partial class BBDD : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Geografía Basica" },
                    { 2, 2, "Cultura General - 1" },
                    { 3, 3, "Cultura General - 2" },
                    { 4, 4, "Inglés Basic - 1" },
                    { 5, 5, "Inglés Animals - 1" },
                    { 6, 6, "Matemáticas - General" },
                    { 7, 7, "Lengua - 1" },
                    { 8, 8, "Lengua - 2" },
                    { 9, 9, "Plastica" },
                    { 10, 10, "Música" },
                    { 11, 11, "Geografía Basica" },
                    { 12, 12, "Cultura General - 1" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 13, 13, "Cultura General - 2" },
                    { 14, 14, "Inglés Basic - 1" },
                    { 15, 15, "Inglés Animals - 1" },
                    { 16, 16, "Matemáticas - General" },
                    { 17, 17, "Lengua - 1" },
                    { 21, 21, "Geografía Basica" },
                    { 22, 22, "Cultura General - 1" },
                    { 23, 23, "Cultura General - 2" },
                    { 24, 24, "Inglés Basic - 1" },
                    { 25, 25, "Inglés Animals - 1" },
                    { 26, 26, "Matemáticas - General" },
                    { 27, 27, "Lengua - 1" },
                    { 31, 31, "Geografía Basica" },
                    { 32, 32, "Cultura General - 1" },
                    { 33, 33, "Cultura General - 2" },
                    { 34, 34, "Inglés Basic - 1" },
                    { 35, 35, "Inglés Animals - 1" },
                    { 36, 36, "Matemáticas - General" },
                    { 37, 37, "Lengua - 1" },
                    { 41, 41, "Geografía Basica" },
                    { 42, 42, "Cultura General - 1" },
                    { 43, 43, "Cultura General - 2" },
                    { 44, 44, "Inglés Basic - 1" },
                    { 45, 45, "Inglés Animals - 1" },
                    { 46, 46, "Matemáticas - General" },
                    { 47, 47, "Lengua - 1" },
                    { 51, 51, "Geografía Basica" },
                    { 52, 52, "Cultura General - 1" },
                    { 53, 53, "Cultura General - 2" },
                    { 54, 54, "Inglés Basic - 1" },
                    { 55, 55, "Inglés Animals - 1" },
                    { 56, 56, "Matemáticas - General" },
                    { 57, 57, "Lengua - 1" }
                });
